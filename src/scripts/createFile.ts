...
export async function createFile(fileName,combinedMetadata) {
    ...
    function InformationWorkSheet(wb,combinedMetadata) {
        ...
        toolversion(ws_info, infoValueStyle, rowNumber + row_Offset_InfoSheet, 2 + col_Offset_InfoSheet, "Metadata Dependency Exporter");
        rowNumber++;
        toolversion(ws_info, headerStyle, rowNumber + row_Offset_InfoSheet, 1 + col_Offset_InfoSheet, "Created By");
        toolversion(ws_info, infoValueStyle, rowNumber + row_Offset_InfoSheet, 2 + col_Offset_InfoSheet, "Paulo Manabe");
        rowNumber++;
